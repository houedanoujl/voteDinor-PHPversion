                            ...
                            @else
                                <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center">
                                    <svg class="w-12 h-12 text-yellow-600 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M12 9v2m0 4v2m9-7a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <h3 class="text-lg font-semibold text-yellow-900 mb-2">Les votes sont temporairement désactivés</h3>
                                    <p class="text-yellow-800">Revenez plus tard pour soutenir {{ $candidate->prenom }}.</p>
                                </div>
                            @endif
                        </div>
                    </div>
