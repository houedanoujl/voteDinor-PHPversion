<div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
    ...
    <form wire:submit.prevent="submit" class="space-y-6">
        ...
        <div>
            <label for="photo" class="block text-sm font-semibold text-gray-700 mb-3">
            ...
            <input type="file" id="photo" wire:model="photo" accept="image/*" @if(($settings?->uploads_enabled ?? true) === false) disabled @endif
            ...
            <p class="mt-2 text-sm text-gray-500">Formats acceptés: PNG, JPG, JPEG. Taille maximale: 3MB.</p>
